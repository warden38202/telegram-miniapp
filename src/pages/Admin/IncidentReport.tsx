    ...
    return (
        <div className="bg-[#080f26] py-4 px-8 w-full">
            ...
            <div className="mt-10 flex gap-4">
                <div className="bg-[#0B1739] flex items-center w-1/4 rounded-lg p-4">
                    ...
                    <div className="ml-3">
                        <h3>Total Users</h3>
                        <label className="text-[12px] text-[#AEB9E1]">250</label>
                    </div>
                </div>
                <div className="bg-[#0B1739] flex items-center w-1/4 rounded-lg p-4">
                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="ml-3">
                        <h3>New Users</h3>
                        <label className="text-[12px] text-[#AEB9E1]">15</label>
                    </div>
                </div>
                <div className="bg-[#0B1739] flex items-center w-1/4 rounded-lg p-4">
                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="ml-3">
                        <h3>Total Cases</h3>
                        <label className="text-[12px] text-[#AEB9E1]">200</label>
                    </div>
                </div>
                <div className="bg-[#0B1739] flex items-center w-1/4 rounded-lg p-4">
                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="ml-3">
                        ...
                        <label className="text-[12px] text-[#AEB9E1]">35</label>
                    </div>
                </div>
            </div>
            <div className="mt-5">
